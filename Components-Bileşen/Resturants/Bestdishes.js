export default function ResturantBestDishes(){
    return(
        <>
                        ...
                        <div id="owl-demo">
                            <div className="item item-type-zoom">
                                ...
                                <div className="item-img">
                                    <img src="special-menu-1.jpg" alt="sp-menu"/>
                                </div>
                            </div>
                            <div className="item item-type-zoom">
                                <a href="#" className="item-hover">
                                ...
                                <div className="item-img">
                                    <img src="special-menu-2.jpg" alt="sp-menu"/>
                                </div>
                            </div>
                            <div className="item item-type-zoom">
                                <a href="#" className="item-hover">
                                ...
                                <div className="item-img">
                                    <img src="special-menu-3.jpg" alt="sp-menu"/>
                                </div>
                            </div>
                            <div className="item item-type-zoom">
                                <a href="#" className="item-hover">
